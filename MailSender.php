...
class MailSender{
    ...
    $this->_mailer->SMTPAuth = true; // Set mailer to use SMTP
        if ($this->_gmail) {
            ...
            $this->_mailer->Port = 857; // TCP port to connect to (Defaut 25)
            ...
            $this->_mailer->Host = 'smtp.gmail.com';  // Specify main and backup server //stmp entrant sortant
        }

	$this->_mailer->SMTPDebug  = 0;  	// Enable SMTP authentication
    $this->_mailer->Username = '1902007_cse@adcet.in';  // SMTP username
    $this->_mailer->Password = 'Aniket@123';  // SMTP password



    $this->_mailer->addReplyTo("aniketkhot8005@gmail.com", "Aniket Khot");
    $this->_mailer->From = 'aniketkhot8005@gmail.com';
